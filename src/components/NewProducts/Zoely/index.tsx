        ...
        <div className="box">
          ...
          >
            <ItemPlus
              ...
              text={
                <div>
                  <span>
                    Пероральный прием NOMAC даже в дозах до 5 мг/сутки
                    существенно не влияет на параметры обмена и гомеостаза
                    <Link
                      style={{
                        fontSize: 16,
                        color: '#0076BD',
                      }}
                      to={'/product/eoeli/effects'}
                    >
                      ¹
                    </Link>
                    , не оказывает заметного прямого действия на кровеносные
                    сосуды
                  </span>
                  <Link
                    style={{
          ...
          >
            <ItemPlus
              ...
              text={
                <div>
                  NOMAC не оказывает значимого влияния на уровень глюкозы в
                  крови натощак или уровень инсулина; уровень общего
                  холестерина, ЛПВП, ЛПНП; уровни фибриногена и плазминогена
                  <Link
                    style={{
                      fontSize: 16,
                      color: '#0076BD',
